...
test("Brazilian Bots and Error 429 Page /web search @api", async ({
  ...
  let response;
  for (let i = 1; i < 12; i++) {
     response = await app.api.search.sendGet("/v4/web/search",
...
test("Brazilian Bots and Error 429 Page /news search @api", async ({
  ...
  // Action
  const response = await app.api.search.sendGet("/news/search",
...
test("Brazilian Bots and Error 429 Page /video search @api", async ({
  ...
  // Action
  const response = await app.api.search.sendGet("/v2/videos/search",
