...
test("Check 202 No Results Found error page ", async ({
  ...
  test("Check infinity scroll to next page", async ({
    ...
    await musicPlaylistPage.track.scrollByVisibleLastTrack()
    await musicPlaylistPage.preloader.waitUntilPreloaderToBeHidden()

    //Assert
    await musicPlaylistPage.track.expectListToBeGreaterThanOrEqual(musicPlaylistPage.track.tracksName, 30)
  });
